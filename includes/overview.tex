...
\begin{tabular}{ l | c c |}
\hline
\multicolumn{1}{ |c| } {\textbf{Experiments}} & \textbf{Shape Errors [mm]} & \textbf{Tip Errors [mm]} \\
\hline
\multicolumn{1}{ |c| } {Experiment1}				& $1.49 \pm 0.84$ & $1.25 \pm 0.67$ \\
\multicolumn{1}{ |c| } {Experiment2}  				& $\textbf{0.83} \pm 0.34$ & $0.96 \pm 0.44$ \\
\hline
\end{tabular}
